									...
									<?php foreach ($order_list_tomeng as $item):?>
										<tr>
											...
											<td id="status<?php echo $item['order_id'];?>">
                                                <div style='color:#ff6bb5'>已备货</div>
											</td>
										...
										<tr>
											...
											<td><div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
                                                        ...
                                                        <button id="btn<?php echo $item['order_id']?>" class='btn btn-primary' type='button' onclick='
                                                                $.post(base_url + "order/end_order",{order_id:<?php echo $item['order_id'];?>},function(data) {
                                                                alert(data);
                                                                })'>标记完成</button>
													</div>
												</div></td>
