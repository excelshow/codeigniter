                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-hover table-bordered" style="width: 80%;margin: auto;">
							...
							<?php endforeach;?>
                            <tr>
                                <td><button class="btn btn-primary" onclick="address = prompt('请输入你要新增的地址');if(address){$.post(base_url + 'setting/add_user_address',{data:address},function(data){alert(data);location.reload(true);});}">新增</button></td>
                            </tr>
                            </tbody>
                        </table>
                        <script>
                            $(".edit").click(function () {
                                ...
                                if(address){
                                    $.post(base_url + 'setting/edit_user_address',{NO:data_NO,data:address},function(data){alert(data);location.reload(true);});

                                }

                                // alert($(this).attr('name'));
                            })
                            var delete_url = base_url + "setting/delete_user_address";
